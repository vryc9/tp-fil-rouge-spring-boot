package com.example.catalog_service.utils.exceptions;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> notFound(NotFoundException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<ProblemDetail> handleInsufficientAuth(InsufficientAuthenticationException ex, HttpServletRequest req) {
